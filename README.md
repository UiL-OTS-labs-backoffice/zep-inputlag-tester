...
* Zep 2.6 on a computer with a parallel port. Having a spare parallel cable to plug your leads into is recommended
...
6. Measurement! Set the scope to "single" mode, hold the photosensor to the screen, and hold shift.
...
* Where you hold the sensor is matters: The bottom of the screen will take longer to update than the top. Keep this consistent between monitors.
* If your light sensor is noisy, make sure the ground and power supply are connected correctly.
* The zep experiment flashes the screen from #111111 to #EEEEEE
